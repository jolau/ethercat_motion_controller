...
/**
 * Encoder Crosschecker between the primary and secondary position.
 */
class EncoderCrosschecker {
 public:
  /**
   * Crosscheck both encoder position. Checks if difference exceed a error margin (with distinction of the direction),
